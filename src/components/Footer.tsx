      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-12">
        <div className="flex flex-col gap-6 sm:col-span-2 lg:col-span-1">
          <div className="flex items-center gap-4">
            ...
            <span className="text-xl md:text-2xl font-display tracking-[0.1em] sm:tracking-[0.2em] font-bold">ROAST N TOAST</span>
          </div>
        ...
        <div>
          <h4 className="text-lg mb-4 sm:mb-6 tracking-widest uppercase font-bold">Hours</h4>
          <ul className="flex flex-col gap-3 text-sm">
