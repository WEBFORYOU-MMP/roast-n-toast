...
export function Footer() {
  ...
  return (
    <footer className={`py-16 px-6 border-t ${isDark ? 'bg-black border-white/10' : 'bg-cream/50 border-primary/10'}`}>
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="flex flex-col gap-6">
          <div className="flex items-center gap-4">
              <div className="relative h-16 w-16 overflow-hidden rounded-full border border-primary/20 bg-background/50 backdrop-blur-sm">
                <Image
            ...
            <span className="text-2xl font-display tracking-[0.2em] font-bold">ROAST N TOAST</span>
          </div>
